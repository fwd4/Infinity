...
def upload_filtered_dataset(template, repo_id, token):
    filtered_base_path = f"{ROOT_DIR}/data/filtered_dataset/template_{template}"
...
def main():
    ...
    parser.add_argument("--token", type=str, required=True, help="Hugging Face private token")
